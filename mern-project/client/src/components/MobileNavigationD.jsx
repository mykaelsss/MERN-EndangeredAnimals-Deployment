...
import NavLinksD from './NavLinksD'
...
const MobileNavigationD = ({check,change}) => {
    ...
    return (
      ...
      { open && <NavLinksD isMobile={true} closeMobileMenu={closeMobileMenu} />}
    </Box>
    )
}

export default MobileNavigationD
